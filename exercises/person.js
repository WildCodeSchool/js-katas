...
* a constructor which initialize three attributes in this ordre : name (string), age (number) and weeaboo (boolean)
...
* a method `match` which receives a person (Person) as parameter and returns true if the current `weeaboo` and argument `weeaboo` values are the same
